...
const QUESTION_POOL = [
  ...
  { id: 2, category: "Bennet & David", tag: "A2", difficulty: "schwer", aktiv: true, shortLabel: "Mit Bennet / David gearbei­teit", text: "Finde jemanden, der/die schon mal mit Bennet oder David zusammengearbeitet hat." },
  ...
  { id: 12, category: "Gäste", tag: "P", difficulty: "schwer", aktiv: true, shortLabel: "Spricht eine weitere Fremd­sprache", text: "Finde jemanden, der/die neben Englisch noch eine weitere Fremdsprache spricht." },
  ...
  { id: 14, category: "Gäste", tag: "C1", difficulty: "mittel", aktiv: true, shortLabel: "Ist oder war Unter­nehmens­berater", text: "Finde jemanden, der/die Unternehmensberater(in) ist oder war." },
  { id: 15, category: "Gäste", tag: "C2", difficulty: "schwer", aktiv: true, shortLabel: "Ist selbst­ständig", text: "Finde jemanden, der/die selbstständig ist." },
  ...
  { id: 17, category: "Gäste", tag: "P", difficulty: "mittel", aktiv: true, shortLabel: "Habe ich heute kennen­gelernt", text: "Finde jemanden, den/die du heute zum ersten Mal triffst." },
  ...
  { id: 19, category: "Gäste", tag: "S", difficulty: "mittel", aktiv: true, shortLabel: "Hat Halb­marathon beendet", text: "Finde jemanden, der/die schon mal erfolgreich einen Halbmarathon beendet hat." },
